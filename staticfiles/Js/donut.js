    var element = document.getElementById("total_orders_value"); // Get the element that holds the values
    // console.log(element.attributes["data-value"].value);
    var order_text = element.attributes["data-value"].value; // get the value, it will be as a 'String'
    ...
    var colors = [ 'yellow', 'skyblue', 'orange', 'red' ,'green'];
